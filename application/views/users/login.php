...
<div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
              <strong class="d-inline-block mb-2 text-primary"><i class="fas fa-door-open"></i></strong>
              <h3 class="mb-0">
              ...
              <p class="card-text text-left mb-auto"><script type="text/javascript" src="https://www.brainyquote.com/link/quotebr.js"></script></p>Don't Have an Account?
...
<?php echo form_open('users/login'); ?>
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			<h1 class="text-center"><i class="fas fa-door-open"></i> <?php echo $title; ?></h1>
